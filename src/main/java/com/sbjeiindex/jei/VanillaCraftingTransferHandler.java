...
public class VanillaCraftingTransferHandler implements IRecipeTransferHandler<CraftingMenu, CraftingRecipe> {
    ...
    @Override
    @Nullable
    public IRecipeTransferError transferRecipe(CraftingMenu menu, CraftingRecipe recipe,
